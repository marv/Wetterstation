...
int HMC6352StartCalibration = 0x43;
int HMC6352StopCalibration = 0x45;
...
{
    Wire.beginTransmission(HMC6352SlaveAddress);
    Wire.write(HMC6352StartCalibration);
    Wire.endTransmission();
    delay(16);
}
void HMC6352Class::StopCalibration()
{
    Wire.beginTransmission(HMC6352SlaveAddress);
    Wire.write(HMC6352StopCalibration);
    Wire.endTransmission();
    delay(16);
}
